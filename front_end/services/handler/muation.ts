...
const useMutationPostLogin = () => {
  ...
  const mutation = useMutation({
    ...
    onSuccess: (data) => {
      if (
        data.mensage == "Unable to create user please review your credentials"
      ) {
        toast({
...
export {
  useMutationPostList,
  useMutationPostLogin,
  useMutationPostUser,
  useMutationPostLogout,
  useMutationPostTask,
  useMutationPostTaskCompleted,
